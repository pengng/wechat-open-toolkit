...
util.buildObject = xmlBuilder.buildObject.bind(buildObject)
...
util.waterfall = function (list, callback) {
  const next = function (err) {
    ...
    let func = list.shift()
    typeof func === 'function' ? func.apply(null, args.concat(next)) : callback(new TypeError('waterfall has an no function'))
  }
  next()
}
