...
const Component = function (options) {
    ...
    this.on(EVENT_COMPONENT_VERIFY_TICKET, this.onComponentVerifyTicket.bind(this))
    ...
    const getComponentVerifyTicketCallback = function (err, componentVerifyTicket) {
        ...
        if (!componentVerifyTicket) {
            return this.once(EVENT_COMPONENT_VERIFY_TICKET, this.start.bind(this))
        }
...
proto.middlewarify = function () {
    const middleware = function (req, res, next) {
        ...
        switch (infoType) {
            case EVENT_COMPONENT_VERIFY_TICKET:
                this.emit(EVENT_COMPONENT_VERIFY_TICKET, {
...
proto.getComponentAccessToken = function (callback) {
    if (!this.componentVerifyTicket) {
        return callback(new WechatOpenToolkitError('The component verify ticket does not exists!'))
    }
