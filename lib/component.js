...
proto.authorizationMiddlewarify = function () {
  ...
  const middleware = function (req, res, next) {
    ...
    this.getAuthorizationUrl(req.url, getAuthorizationUrlCallback.bind(this, req, res, next))
  }
  return middleware.bind(this)
}
...
proto.getAuthorizationUrl = function (redirectUrl, callback) {
  const getPreAuthCodeCallback = function (err, result) {
    ...
    const query = {
      component_appid: this.componentAppId,
      pre_auth_code: encodeURIComponent(result.pre_auth_code),
